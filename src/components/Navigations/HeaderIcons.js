    ...
    return (
        <div className='flex justify-center gap-9'>
            ...
            <div className='relative '>
                <svg onClick={() => setTab(true)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="transition-transform duration-300 ease-in-out hover:scale-110 cursor-pointer text-primary size-6 opacity-80">
                ...
                <div className={`z-10 ${tab ? "block" : "hidden"} absolute text-sm top-10 right-4 bg-white border border-gray-50 rounded-2xl p-5 shadow`}>
                    <div className='relative'>
                        ...
                        <div className='cursor-pointer flex gap-3 text-gray-500 font-poppins mb-3'>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="transition-transform duration-300 ease-in-out hover:scale-110 cursor-pointer text-primary size-5 opacity-80">
