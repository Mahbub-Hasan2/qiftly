    ...
    return (
        <div className='flex justify-center gap-5 md:gap-9'>
            ...
            <div className='block md:hidden'>
                <a
                    href="https://wa.me/+97430671369"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                    <div className='cursor-pointer flex gap-3 text-gray-500 font-poppins'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="transition-transform duration-300 ease-in-out hover:scale-110 cursor-pointer text-primary size-7 ">
            ...
            >
                <Search className="  cursor-pointer text-primary size-7" />
            </button>
